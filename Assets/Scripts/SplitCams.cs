...
public class SplitCams : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 NextCamera1Pos = new Vector3(Camera1.transform.position.x, Player1.transform.position.y, CamDistance);
        Vector3 NextCamera2Pos = new Vector3(Camera2.transform.position.x, Player2.transform.position.y, CamDistance);
